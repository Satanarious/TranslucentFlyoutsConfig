...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.addButton = QtWidgets.QPushButton(parent=self.disabledList_frame)
        self.addButton.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.addButton.setText("")
        self.addButton.setIconSize(QtCore.QSize(15, 15))
        ...
        self.applyButton.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        ...
        spacerItem3 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit.setPlaceholderText(_translate("Form", "Process Name, e.g. explorer.exe"))
        self.disabledNote.setText(_translate("Form", "Note: Adding any process to this list would turn off the functionality of this section for that."))
