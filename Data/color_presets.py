...
class ColorPresets:
    ...
    def presetChanged(window: Main) -> None:
        ...
        window.background_color_picker.setStyleSheet(
            StyleSheet.buttonColorStylesheet(ColorPicker.aarrggbb_to_rgba(backgroundColor), AppSettings.secondaryBackgroundColor)
        )
        secondaryBackgroundColor = "FF" + presetParams[ColorPresets.Key.SecondaryBackgroundColor][1:]
        window.secondaryBackgroundColor.setText(secondaryBackgroundColor)
        window.secondary_background_color_picker.setStyleSheet(
            StyleSheet.buttonColorStylesheet(ColorPicker.aarrggbb_to_rgba(secondaryBackgroundColor), AppSettings.secondaryBackgroundColor)
        )
        labelColor = "FF" + presetParams[ColorPresets.Key.LabelColor][1:]
        window.labelColor.setText(labelColor)
        window.label_color_picker.setStyleSheet(StyleSheet.buttonColorStylesheet(ColorPicker.aarrggbb_to_rgba(labelColor), AppSettings.secondaryBackgroundColor))
        textColor = "FF" + presetParams[ColorPresets.Key.TextColor][1:]
        window.textColor.setText(textColor)
        window.text_color_picker.setStyleSheet(StyleSheet.buttonColorStylesheet(ColorPicker.aarrggbb_to_rgba(textColor), AppSettings.secondaryBackgroundColor))
