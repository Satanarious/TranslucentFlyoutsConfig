...
class ClassVar:
    ...
    darkModeThemeColorizationType: str = "darkModeThemeColorizationType"
    lightModeThemeColorizationType: str = "lightModeThemeColorizationType"
    width: str = "width"
...
class Saved:
    ...
    def updateJSON():
        """
        Dumps updates dictionary values in the json
        """
        with open(DBPath, "w") as json_file:
    ...
    def updateUI(window: Main):
        """
        Updates the various interactable widgets in the UI to the saved value
        ...
        window.enableMiniDump.setCurrentIndex(Saved.Global.enableMiniDump)
        window.noBorderColor1.setCurrentIndex(Saved.Global.noBorderColor)
        window.enableThemeColorization1.setCurrentIndex(
            Saved.Global.enableThemeColorization
        )
        window.darkModeThemeColorizationType1.setCurrentIndex(
            Saved.Global.darkModeThemeColorizationType
        )
        window.lightModeThemeColorizationType1.setCurrentIndex(
        ...
        if Saved.Global.darkModeBorderColor != Defaults.Global.darkModeBorderColor:
            ColorPicker.changeButtonColor(
                Saved.Global.darkModeBorderColor, window.dark_mode_border_color_picker1
            )
        ...
        if Saved.Global.lightModeBorderColor != Defaults.Global.lightModeBorderColor:
            ColorPicker.changeButtonColor(
                ...
                window.light_mode_border_color_picker1,
            )
        ...
        if Saved.Global.darkModeGradientColor != Defaults.Global.darkModeGradientColor:
            ColorPicker.changeButtonColor(
                ...
                window.dark_mode_gradient_color_picker1,
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Global.lightModeGradientColor,
                window.light_mode_gradient_color_picker1,
            )
        # window.disabledList1
        ...
        if Saved.DropDown.darkModeBorderColor != Defaults.DropDown.darkModeBorderColor:
            ColorPicker.changeButtonColor(
                ...
                window.dark_mode_border_color_picker2,
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.DropDown.lightModeBorderColor,
                window.light_mode_border_color_picker2,
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.DropDown.darkModeGradientColor,
                window.dark_mode_gradient_color_picker2,
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.DropDown.lightModeGradientColor,
                window.light_mode_gradient_color_picker2,
            )
        # window.disabledList2
        window.disabledEffect2.setCurrentIndex(Saved.DropDown.disabled)

        # DropDown-Animation
        window.fadeOutTime1.setValue(Saved.DropDown.Animation.fadeOutTime)
        window.popInTime1.setValue(Saved.DropDown.Animation.popInTime)
        window.fadeInTime1.setValue(Saved.DropDown.Animation.fadeInTime)
        window.popInStyle1.setCurrentIndex(Saved.DropDown.Animation.popInStyle)
        window.startRatio1.setValue(Saved.DropDown.Animation.startRatio)
        window.enableImmediateInterupting1.setCurrentIndex(
        ...
        window.enableFluentAnimation2.setCurrentIndex(Saved.Menu.enableFluentAnimation)
        window.enableCompatibilityMode.setCurrentIndex(
            Saved.Menu.enableCompatibilityMode
        )
        window.noModernAppBackgroundColor.setCurrentIndex(
        ...
        if Saved.Menu.colorTreatAsTransparent != Defaults.Menu.colorTreatAsTransparent:
            ColorPicker.changeButtonColor(
                ...
                window.color_treat_as_transparent_color_picker,
            )
        window.colorTreatAsTransparentThreshold.setValue(
        ...
        window.enableThemeColorization3_1.setCurrentIndex(
            Saved.Menu.enableThemeColorization
        )
        window.darkModeThemeColorizationType2.setCurrentIndex(
            Saved.Menu.darkModeThemeColorizationType
        )
        window.lightModeThemeColorizationType2.setCurrentIndex(
        ...
        if Saved.Menu.darkModeBorderColor != Defaults.Menu.darkModeBorderColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.darkModeBorderColor, window.dark_mode_border_color_picker3
            )
        ...
        if Saved.Menu.lightModeBorderColor != Defaults.Menu.lightModeBorderColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.lightModeBorderColor, window.light_mode_border_color_picker3
            )
        ...
        if Saved.Menu.darkModeGradientColor != Defaults.Menu.darkModeGradientColor:
            ColorPicker.changeButtonColor(
                ...
                window.dark_mode_gradient_color_picker3,
            )
        ...
        if Saved.Menu.lightModeGradientColor != Defaults.Menu.lightModeGradientColor:
            ColorPicker.changeButtonColor(
                ...
                window.light_mode_gradient_color_picker3,
            )
        # window.disabledList3
        window.disabledEffect3_1.setCurrentIndex(Saved.Menu.disabled)

        # Menu-Animation
        window.fadeOutTime2.setValue(Saved.Menu.Animation.fadeOutTime)
        window.popInTime2.setValue(Saved.Menu.Animation.popInTime)
        window.fadeInTime2.setValue(Saved.Menu.Animation.fadeInTime)
        window.popInStyle2.setCurrentIndex(Saved.Menu.Animation.popInStyle)
        window.startRatio2.setValue(Saved.Menu.Animation.startRatio)
        window.enableImmediateInterupting2.setCurrentIndex(
        ...
        if Saved.Menu.Hot.darkModeColor != Defaults.Menu.Hot.darkModeColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.Hot.darkModeColor, window.dark_mode_color_picker1_1
            )
        ...
        if Saved.Menu.Hot.lightModeColor != Defaults.Menu.Hot.lightModeColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.Hot.lightModeColor, window.light_mode_color_picker1_1
            )
        ...
        window.enableThemeColorization3_2.setCurrentIndex(
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Menu.DisabledHot.darkModeColor, window.dark_mode_color_picker1_2
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Menu.DisabledHot.lightModeColor, window.light_mode_color_picker1_2
            )
        ...
        window.enableThemeColorization3_3.setCurrentIndex(
        ...
        if Saved.Menu.Focusing.darkModeColor != Defaults.Menu.Focusing.darkModeColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.Focusing.darkModeColor, window.dark_mode_color_picker1_3
            )
        ...
        if Saved.Menu.Focusing.lightModeColor != Defaults.Menu.Focusing.lightModeColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.Focusing.lightModeColor, window.light_mode_color_picker1_3
            )
        ...
        if Saved.Menu.Separator.darkModeColor != Defaults.Menu.Separator.darkModeColor:
            ColorPicker.changeButtonColor(
                Saved.Menu.Separator.darkModeColor, window.dark_mode_color_picker1_4
            )
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Menu.Separator.lightModeColor, window.light_mode_color_picker1_4
            )
        ...
        window.enableThemeColorization3_5.setCurrentIndex(
        ...
        window.enableThemeColorization4.setCurrentIndex(
            Saved.Tooltip.enableThemeColorization
        )
        window.marginsType.setCurrentIndex(Saved.Tooltip.marginsType)
        window.marginLeft.setValue(Saved.Tooltip.marginLeft)
        window.marginRight.setValue(Saved.Tooltip.marginRight)
        window.marginTop.setValue(Saved.Tooltip.marginTop)
        window.marginBottom.setValue(Saved.Tooltip.marginBottom)

        window.darkModeColor2.setText(Saved.Tooltip.darkModeColor)
        window.lightModeColor2.setText(Saved.Tooltip.lightModeColor)
        ...
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Tooltip.darkModeGradientColor,
                window.dark_mode_gradient_color_picker4,
            )
        if (
            ...
            ColorPicker.changeButtonColor(
                Saved.Tooltip.lightModeGradientColor,
                window.light_mode_gradient_color_picker4,
            )
    ...
    class Global:
        ...
        enableMiniDump: int = rawDefaults[Key._global][Key.enableMiniDump]
        ...
        def updateDict():
            """
            Method to update the dictionary to the latest values from the UI
            """
            ...
            rawDefaults[Key._global][Key.enableDropShadow] = (
                Saved.Global.enableDropShadow
            )
            rawDefaults[Key._global][Key.enableMiniDump] = Saved.Global.enableMiniDump
            rawDefaults[Key._global][Key.noBorderColor] = Saved.Global.noBorderColor
            rawDefaults[Key._global][Key.enableThemeColorization] = (
                Saved.Global.enableThemeColorization
            )
            rawDefaults[Key._global][Key.darkModeThemeColorizationType] = (
                Saved.Global.darkModeThemeColorizationType
            )
            rawDefaults[Key._global][Key.lightModeThemeColorizationType] = (
                Saved.Global.lightModeThemeColorizationType
            )
            rawDefaults[Key._global][Key.darkModeBorderColor] = (
                Saved.Global.darkModeBorderColor
            )
            rawDefaults[Key._global][Key.lightModeBorderColor] = (
                Saved.Global.lightModeBorderColor
            )
            rawDefaults[Key._global][Key.darkModeGradientColor] = (
                Saved.Global.darkModeGradientColor
            )
            rawDefaults[Key._global][Key.lightModeGradientColor] = (
                Saved.Global.lightModeGradientColor
            )
            rawDefaults[Key._global][Key.disabledList] = Saved.Global.disabledList
            rawDefaults[Key._global][Key.disabled] = Saved.Global.disabled

        @staticmethod
        def updateDisabledListInDict():
            """
            Method to update the disabledList in the dictionary to the latest values from the UI
            """
            rawDefaults[Key._global][Key.disabledList] = Saved.Global.disabledList

        @staticmethod
        def updateBlockListInDict():
            """
            Method to update the disabledList in the dictionary to the latest values from the UI
            """
            rawDefaults[Key._global][Key.disabledList] = Saved.Global.disabledList
    ...
    class DropDown:
        ...
        def updateDisabledListInDict():
            ...
            Method to update the disabledList in the dictionary to the latest values from the UI
            """
            rawDefaults[Key.dropdown][Key.disabledList] = Saved.DropDown.disabledList
        ...
        def updateDict():
            ...
            rawDefaults[Key.dropdown][Key.enableDropShadow] = (
                Saved.DropDown.enableDropShadow
            )
            rawDefaults[Key.dropdown][Key.enableFluentAnimation] = (
                Saved.DropDown.enableFluentAnimation
            )
            rawDefaults[Key.dropdown][Key.noBorderColor] = Saved.DropDown.noBorderColor
            rawDefaults[Key.dropdown][Key.enableThemeColorization] = (
                Saved.DropDown.enableThemeColorization
            )
            rawDefaults[Key.dropdown][Key.darkModeBorderColor] = (
                Saved.DropDown.darkModeBorderColor
            )
            rawDefaults[Key.dropdown][Key.lightModeBorderColor] = (
                Saved.DropDown.lightModeBorderColor
            )
            rawDefaults[Key.dropdown][Key.darkModeGradientColor] = (
                Saved.DropDown.darkModeGradientColor
            )
            rawDefaults[Key.dropdown][Key.lightModeGradientColor] = (
                Saved.DropDown.lightModeGradientColor
            )
            rawDefaults[Key.dropdown][Key.disabledList] = Saved.DropDown.disabledList
        ...
        class Animation:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.dropdown][Key.animation][Key.fadeOutTime] = (
                    Saved.DropDown.Animation.fadeOutTime
                )
                rawDefaults[Key.dropdown][Key.animation][Key.popInTime] = (
                    Saved.DropDown.Animation.popInTime
                )
                rawDefaults[Key.dropdown][Key.animation][Key.fadeInTime] = (
                    Saved.DropDown.Animation.fadeInTime
                )
                rawDefaults[Key.dropdown][Key.animation][Key.popInStyle] = (
                    Saved.DropDown.Animation.popInStyle
                )
                rawDefaults[Key.dropdown][Key.animation][Key.startRatio] = (
                    Saved.DropDown.Animation.startRatio
                )
                rawDefaults[Key.dropdown][Key.animation][
                    Key.enableImmediateInterupting
                ] = Saved.DropDown.Animation.enableImmediateInterupting
    ...
    class Menu:
        ...
        darkModeThemeColorizationType: int = rawDefaults[Key.menu][
            Key.darkModeThemeColorizationType
        ]
        lightModeThemeColorizationType: int = rawDefaults[Key.menu][
            Key.lightModeThemeColorizationType
        ]
        ...
        def updateDisabledListInDict():
            ...
            Method to update the disabledList in the dictionary to the latest values from the UI
            """
            rawDefaults[Key.menu][Key.disabledList] = Saved.Menu.disabledList
        ...
        def updateDict():
            ...
            Method to update the dictionary to the latest values from the UI
            """
            rawDefaults[Key.menu][Key.noSystemDropShadow] = (
                Saved.Menu.noSystemDropShadow
            )
            rawDefaults[Key.menu][Key.enableImmersiveStyle] = (
                Saved.Menu.enableImmersiveStyle
            )
            rawDefaults[Key.menu][Key.enableCustomRendering] = (
                Saved.Menu.enableCustomRendering
            )
            rawDefaults[Key.menu][Key.enableFluentAnimation] = (
                Saved.Menu.enableFluentAnimation
            )
            rawDefaults[Key.menu][Key.enableCompatibilityMode] = (
                Saved.Menu.enableCompatibilityMode
            )
            rawDefaults[Key.menu][Key.noModernAppBackgroundColor] = (
                Saved.Menu.noModernAppBackgroundColor
            )
            rawDefaults[Key.menu][Key.colorTreatAsTransparent] = (
                Saved.Menu.colorTreatAsTransparent
            )
            rawDefaults[Key.menu][Key.colorTreatAsTransparentThreshold] = (
                Saved.Menu.colorTreatAsTransparentThreshold
            )
            ...
            rawDefaults[Key.menu][Key.enableThemeColorization] = (
                Saved.Menu.enableThemeColorization
            )
            rawDefaults[Key.menu][Key.darkModeThemeColorizationType] = (
                Saved.Menu.darkModeThemeColorizationType
            )
            rawDefaults[Key.menu][Key.lightModeThemeColorizationType] = (
                Saved.Menu.lightModeThemeColorizationType
            )
            rawDefaults[Key.menu][Key.darkModeBorderColor] = (
                Saved.Menu.darkModeBorderColor
            )
            rawDefaults[Key.menu][Key.lightModeBorderColor] = (
                Saved.Menu.lightModeBorderColor
            )
            rawDefaults[Key.menu][Key.darkModeGradientColor] = (
                Saved.Menu.darkModeGradientColor
            )
            rawDefaults[Key.menu][Key.lightModeGradientColor] = (
                Saved.Menu.lightModeGradientColor
            )
            rawDefaults[Key.menu][Key.disabledList] = Saved.Menu.disabledList
        ...
        class Animation:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.menu][Key.animation][Key.fadeOutTime] = (
                    Saved.Menu.Animation.fadeOutTime
                )
                rawDefaults[Key.menu][Key.animation][Key.popInTime] = (
                    Saved.Menu.Animation.popInTime
                )
                rawDefaults[Key.menu][Key.animation][Key.fadeInTime] = (
                    Saved.Menu.Animation.fadeInTime
                )
                rawDefaults[Key.menu][Key.animation][Key.popInStyle] = (
                    Saved.Menu.Animation.popInStyle
                )
                rawDefaults[Key.menu][Key.animation][Key.startRatio] = (
                    Saved.Menu.Animation.startRatio
                )
                rawDefaults[Key.menu][Key.animation][Key.enableImmediateInterupting] = (
                    Saved.Menu.Animation.enableImmediateInterupting
                )
        ...
        class DisabledHot:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.menu][Key.disabledHot][Key.cornerRadius] = (
                    Saved.Menu.DisabledHot.cornerRadius
                )
                rawDefaults[Key.menu][Key.disabledHot][Key.darkModeColor] = (
                    Saved.Menu.DisabledHot.darkModeColor
                )
                rawDefaults[Key.menu][Key.disabledHot][Key.lightModeColor] = (
                    Saved.Menu.DisabledHot.lightModeColor
                )
                rawDefaults[Key.menu][Key.disabledHot][Key.enableThemeColorization] = (
                    Saved.Menu.DisabledHot.enableThemeColorization
                )
                rawDefaults[Key.menu][Key.disabledHot][Key.disabled] = (
        ...
        class Focusing:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.menu][Key.focusing][Key.width] = (
                    Saved.Menu.Focusing.width
                )
                rawDefaults[Key.menu][Key.focusing][Key.cornerRadius] = (
                    Saved.Menu.Focusing.cornerRadius
                )
                rawDefaults[Key.menu][Key.focusing][Key.darkModeColor] = (
                    Saved.Menu.Focusing.darkModeColor
                )
                rawDefaults[Key.menu][Key.focusing][Key.lightModeColor] = (
                    Saved.Menu.Focusing.lightModeColor
                )
                rawDefaults[Key.menu][Key.focusing][Key.enableThemeColorization] = (
                    Saved.Menu.Focusing.enableThemeColorization
                )
                rawDefaults[Key.menu][Key.focusing][Key.disabled] = (
                    Saved.Menu.Focusing.disabled
                )
        ...
        class Hot:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.menu][Key.hot][Key.cornerRadius] = (
                    Saved.Menu.Hot.cornerRadius
                )
                rawDefaults[Key.menu][Key.hot][Key.darkModeColor] = (
                    Saved.Menu.Hot.darkModeColor
                )
                rawDefaults[Key.menu][Key.hot][Key.lightModeColor] = (
                    Saved.Menu.Hot.lightModeColor
                )
                rawDefaults[Key.menu][Key.hot][Key.enableThemeColorization] = (
                    Saved.Menu.Hot.enableThemeColorization
                )
        ...
        class Separator:
            ...
            def updateDict():
                ...
                Method to update the dictionary to the latest values from the UI
                """
                rawDefaults[Key.menu][Key.separator][Key.width] = (
                    Saved.Menu.Separator.width
                )
                rawDefaults[Key.menu][Key.separator][Key.cornerRadius] = (
                    Saved.Menu.Separator.cornerRadius
                )
                rawDefaults[Key.menu][Key.separator][Key.darkModeColor] = (
                    Saved.Menu.Separator.darkModeColor
                )
                rawDefaults[Key.menu][Key.separator][Key.lightModeColor] = (
                    Saved.Menu.Separator.lightModeColor
                )
                rawDefaults[Key.menu][Key.separator][Key.enableThemeColorization] = (
                    Saved.Menu.Separator.enableThemeColorization
                )
                rawDefaults[Key.menu][Key.separator][Key.disabled] = (
    ...
    class Tooltip:
        ...
        def updateDisabledListInDict():
            ...
            Method to update the disabledList in the dictionary to the latest values from the UI
            """
            rawDefaults[Key.tooltip][Key.disabledList] = Saved.Tooltip.disabledList
        ...
        def updateDict():
            ...
            rawDefaults[Key.tooltip][Key.enableDropShadow] = (
                Saved.Tooltip.enableDropShadow
            )
            rawDefaults[Key.tooltip][Key.noBorderColor] = Saved.Tooltip.noBorderColor
            rawDefaults[Key.tooltip][Key.enableThemeColorization] = (
                Saved.Tooltip.enableThemeColorization
            )
            rawDefaults[Key.tooltip][Key.marginsType] = Saved.Tooltip.marginsType
            rawDefaults[Key.tooltip][Key.marginLeft] = Saved.Tooltip.marginLeft
            rawDefaults[Key.tooltip][Key.marginRight] = Saved.Tooltip.marginRight
            rawDefaults[Key.tooltip][Key.marginTop] = Saved.Tooltip.marginTop
            rawDefaults[Key.tooltip][Key.marginBottom] = Saved.Tooltip.marginBottom
            rawDefaults[Key.tooltip][Key.darkModeColor] = Saved.Tooltip.darkModeColor
            rawDefaults[Key.tooltip][Key.lightModeColor] = Saved.Tooltip.lightModeColor
            rawDefaults[Key.tooltip][Key.darkModeBorderColor] = (
                Saved.Tooltip.darkModeBorderColor
            )
            rawDefaults[Key.tooltip][Key.lightModeBorderColor] = (
                Saved.Tooltip.lightModeBorderColor
            )
            rawDefaults[Key.tooltip][Key.darkModeGradientColor] = (
                Saved.Tooltip.darkModeGradientColor
            )
            rawDefaults[Key.tooltip][Key.lightModeGradientColor] = (
                Saved.Tooltip.lightModeGradientColor
            )
            rawDefaults[Key.tooltip][Key.disabledList] = Saved.Tooltip.disabledList
